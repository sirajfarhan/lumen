...
Does the question put the user inside a concrete moment where the skill should help, rather than asking them to define the skill in the abstract?

Example that FAILS this criterion:

> What should a skill for creating a skill help you do when you need it?

### term-after-idea

In a teaching turn, does any formal term arrive only after the user has met the idea through a concrete situation?

Example that FAILS this criterion:

> A capability invariant is the transformation your skill must preserve. What is yours?
