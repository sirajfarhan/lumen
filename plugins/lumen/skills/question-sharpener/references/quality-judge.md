...
Does the question isolate exactly one consequential fork — one distinction whose answer changes what happens next?

Example that FAILS this criterion:

> What matters most to you here, what have you tried, and what would success look like?
