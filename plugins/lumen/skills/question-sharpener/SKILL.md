...
6. Run the packet through Lumen before claiming the inquiry path is ready.
7. Repair from the returned feedback and resubmit when the inquiry path changes.
